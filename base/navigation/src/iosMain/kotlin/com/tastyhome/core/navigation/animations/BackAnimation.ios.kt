...
package com.tastyhome.core.navigation.animations
...
actual fun defaultStackAnimator(): StackAnimator = iosLikeSlide()

actual fun <C : Any, T : Any> predictiveBackParams(
    backHandler: BackHandler,
    onBack: () -> Unit,
): (ChildStack<C, T>) -> PredictiveBackParams? = {
    PredictiveBackParams(backHandler = backHandler, onBack = onBack)
}